...
#        (MUST MATCH ABLATION TRAINING CODE EXACTLY)
# ============================================================
...
class DeepEncoder(nn.Module):
    def __init__(self, in_ch=1, base=32, n_blocks=8):
        ...
        # ABLATION: Standard NAFBlocks only
...
def main():
    ...
    # 2. Load Models (Ablation: No Dose Args)
    # Important: Default init here uses the ablation architecture
    ...
    if args.save_images:
        out_img_dir = os.path.join(args.weights_dir, "eval_images_ablation")
        os.makedirs(out_img_dir, exist_ok=True)
        print(f"Saving images to: {out_img_dir}")

    print("\nRunning Ablation (No Dose) Evaluation...")
    ...
    # 4. Print Results
    print("\n" + "="*55)
    print("      ABLATION (NO DOSE) RESULTS      ")
    print("="*55)
